...
export class ParanormalPower {
  private props: ParanormalPowerProps;
  ...
  public addParanormalPowerEffect(paranormalPowerEffect: Effect): void {
    this.props.effect.addEffect(paranormalPowerEffect);
    this.props.updatedAt = new Date();
  }

  public removeParanormalPowerEffect(paranormalPowerId: string): void {
    this.props.effect.removeEffect(paranormalPowerId);
    this.props.updatedAt = new Date();
  }
